...
export const segments: SegmentPage[] = [
  // ── 1. CSR & Corporate Gifts ──────────────────────────────────────
  {
    slug: "csr-corporate-gifts",
    label: "CSR & Corporate Gifts",
    ...
    cta: {
      label: "Plan your green campaign on WhatsApp",
      whatsappText:
  ...
  // ── 3. Plantable Brand Materials ─────────────────────────────────
  {
    ...
    productSlugs: [
      ...
      "branded-sleeves-inserts",
      "plantable-business-cards",
      "blank-seed-paper-tags",
    ],
    startingFrom: "Custom-quoted",
    moq: "From 300–500 units",
    leadTime: "7–10 working days after design approval",
    cta: {
      label: "Get a branding materials quote on WhatsApp",
      whatsappText:
        "Hi Boxit, I need plantable brand materials for my product brand. Item: ___. Quantity: ___. Please share pricing and sample options.",
    },
    seo: {
