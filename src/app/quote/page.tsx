    ...
    <section className="section">
      <div className="container-page max-w-3xl">
        ...
        <p className="mt-5 text-lg text-muted-foreground">
          We don&apos;t publish fixed prices because every project is custom.
          Answer a few questions and we&apos;ll come back with material
          recommendations, MOQ, timeline and pricing.
        </p>
